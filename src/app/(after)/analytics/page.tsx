...
import { UserTier } from "@/data/type/user";
...
function UserAnalyticsContent() {
  ...
  const userTier : any = "FREE"; // Can be "FREE", "BASIC", or "PRO"
  const timeRange = "30d";
  ...
  const renderSkillChart = () => {
    const skills = [
      { name: "Technical", score: skillScores.technical, color: "bg-blue-500" },
      {
        ...
        {skills.map((skill) => (
          <div key={skill.name} className="space-y-2">
            ...
            <div className="w-full bg-muted rounded-full h-2.5">
              <div
                className={`${skill.color} h-2.5 rounded-full transition-all`}
  ...
  return (
    <div className="container my-6 space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-2 space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                Interviews above pass threshold
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent>
          {userTier !== "FREE" ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <Button asChild>
                <Link href="/user">Upgrade to BASIC</Link>
              </Button>
            </div>
          )}
        </CardContent>
        ...
        <CardContent>
          {userTier === "PRO" ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <Button asChild>
                <Link href="/user">Upgrade to PRO</Link>
              </Button>
            </div>
          )}
        </CardContent>
      ...
      {/* Pass vs Fail + Recent Interviews */}
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-muted-foreground">
                  {metrics.passRate}% ({Math.round((metrics.totalInterviews * metrics.passRate) / 100)} interviews)
                </span>
              </div>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-muted-foreground">
                  {metrics.failRate}% ({Math.round((metrics.totalInterviews * metrics.failRate) / 100)} interviews)
                </span>
              </div>
              <div className="w-full bg-muted rounded-full h-3 mt-2 flex overflow-hidden">
                <div
